...
const Typography = ({ text, variant, className, ...props }: Props) => {
  switch (variant) {
    case "h1": {
      return (
        <h1
    ...
    case "h2": {
      return (
        <h2
          className={`text-3xl font-bold lg:text-4xl ${className}`}
          {...props}
        >
          {text}
        </h2>
    ...
    case "h3": {
      return (
        <h3
          className={`text-2xl font-bold lg:text-3xl ${className}`}
          {...props}
        >
          {text}
        </h3>
